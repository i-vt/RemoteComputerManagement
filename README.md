...
## Virus Total
- [Windows](https://www.virustotal.com/gui/file/c459817162c55685fcd70fb6a7dcd455b5ae764faa5875f29244ab0d96d43f40/behavior)
<img width="2424" height="665" alt="image" src="https://github.com/user-attachments/assets/c1fecfd5-1ca3-43ef-a456-062260e072b5" />

- [Linux](https://www.virustotal.com/gui/file/cd82737e96eb310910cdbab40cb1fe7e4b5742b5e9cc3c85f1f00ed7aedceb28?nocache=1)
<img width="2404" height="640" alt="image" src="https://github.com/user-attachments/assets/362d90ed-9e3e-4292-bf46-2ecceeb769b9" />

## Disclaimer for "RemoteComputerManagement":
...
7. Unauthorized Access: Using "RemoteComputerManagement" to access, probe, or connect to systems, networks, or data without explicit permission from appropriate parties is strictly discouraged, unethical, and illegal. Unauthorized access to systems, networks, or data breaches various local, national, and international laws, and can result in severe legal consequences. Always obtain the necessary permissions before accessing any systems or data. The developers of "RemoteComputerManagement" disavow any actions taken by individuals or entities that use this software for unauthorized activities.

By downloading, installing, or using "RemoteComputerManagement" you acknowledge that you have read, understood, and agreed to abide by this disclaimer. If you do not agree to these terms, do not use the software.
